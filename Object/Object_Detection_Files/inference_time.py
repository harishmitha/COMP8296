...
picam2 = Picamera2()
picam2.configure(picam2.create_video_configuration(main={"size": (160, 160)}))  # Adjust size for object detection
...
# Quantization
# Set the backend to fbgemm (for CPU)
...
# Fuse layers
# Now you would need to calibrate with some sample inputs (optional step)
# This is where you would pass some input data through the model to collect statistics.
